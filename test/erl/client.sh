...
ERL_THRIFT=~/repository/thrift/lib/erl
#ERL_THRIFT=../../../../thrift/thrift/lib/erl
AMQP_SERVER=../../../rabbitmq-server
AMQP_CLIENT=../../../rabbitmq-erlang-client
...
erl +K true -pa ${ERL_THRIFT}/ebin -pa ${AMQP_CLIENT}/ebin -pa ${AMQP_SERVER}/ebin -pa ../../ebin
